...
### Pod每次被创建，都会伴随一个Pause的容器产生，该容器的作用是什么？[1]
...
### Pod中定义容器的restartPolicy三种重启策略，各自的区别，以及与探针的互相影响有哪些？
...
### Yaml文件中的**Annotations**和**Label**是什么，二者的区别。
...
### kubectl create 和 apply 二者操作的区别是什么？
